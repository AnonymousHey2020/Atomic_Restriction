...
namespace {
    ...
    private:
        ...
        const GlobalValue* noInstrumentGV;
        bool hasGV = false;
    ...
    public:
        ...
        void getGlobalAddress(MachineFunction &MF)
        {
            ...
            noInstrumentGV = M.getNamedValue("noInstrument");
            hasGV = true;
        }
